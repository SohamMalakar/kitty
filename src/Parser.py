...
class Parser:
    ...
    def parse_expression(self, precedence):
        ...
        if prefix_fn is None:
            raise Exception("No prefix parse function error!")
        
        left_expr = prefix_fn()

        while self.peek_token() != TokenType.SEMICOLON and precedence.value < self.peek_precedence().value:
    ...
    def parse_grouped_expression(self):
        ...
        if self.peek_token().type != TokenType.RPAREN:
            raise Exception("Expected a right parenthesis!")
